...
const features = [
    {
        name: 'PHP Autoloader',
        description:
            'HotelBookingOnline uses Composer to autoload your PHP files and namespaces all without having to manually to include/require them.',
        icon: FolderIcon,
    },
    {
    ...
    },
    {
        ...
        description: 'HotelBookingOnline uses wp-scripts under the hood to give you the latest and greatest of WordPress Block Development.',
        icon: CubeIcon,
    },
    {
